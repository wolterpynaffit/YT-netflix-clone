  ...
  return (
    <div className = "row">
      ...
      <div className='row_posters'>
        ...
        {movies.map(
          (movie) => (
          // this prevents deadlinks from displaying | Initially making this change broke something in the application, the Large poster images disappeared and a string of random characters appeared instead. In order to fix this we need to wrap the expression in parenthesis:

          //    (isLargeRow && movie.poster_path) || 
          //(!isLargeRow && movie.backdrop_path && (THIS IS WHAT MADE IT BREAK) 
          ((isLargeRow && movie.poster_path) || 
